lyValue.ntVOID (fn _ => ( let val  ID1 = ID1 ()
 ...
 in ( LrTable.NT 9, ( result, COMMA1left, tyfield_list1right), rest671
)
end
...
|  ( 18, ( ( _, ( MlyValue.ntVOID l_value_aux1, _, l_value_aux1right))
 :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ( let val  ID1 = ID1 ()
 val  l_value_aux1 = l_value_aux1 ()
 in ()
end; ()))
 in ( LrTable.NT 10, ( result, ID1left, l_value_aux1right), rest671)

end
|  ( 19, ( rest671)) => let val  result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 11, ( result, defaultPos, defaultPos), rest671)
end
|  ( 20, ( ( _, ( MlyValue.ntVOID l_value_aux1, _, l_value_aux1right))
...
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  ID1
 ...
 in ( LrTable.NT 11, ( result, DOT1left, l_value_aux1right), rest671)

end
|  ( 21, ( ( _, ( MlyValue.ntVOID l_value_aux1, _, l_value_aux1right))
 ...
 in ( LrTable.NT 11, ( result, LBRACK1left, l_value_aux1right), 
rest671)
end
|  ( 22, ( ( _, ( MlyValue.ntVOID l_value1, l_value1left, 
...
param_list1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: 
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  ID1
 = ID1 ()
 val  param_list1 = param_list1 ()
 in ()
end; ()))
...
rec_list1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: 
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  ID1
 = ID1 ()
 val  rec_list1 = rec_list1 ()
 in ()
end; ()))
...
|  ( 49, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.ntVOID 
exp_list1, _, _)) :: _ :: ( _, ( MlyValue.ntVOID decs1, _, _)) :: ( _,
...
|  ( 51, ( ( _, ( MlyValue.ntVOID exp_tail1, _, exp_tail1right)) :: (
 _, ( MlyValue.ntVOID exp1, exp1left, _)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ( let val  exp1 = exp1 ()
 val  exp_tail1 = exp_tail1 ()
 in ()
end; ()))
 in ( LrTable.NT 12, ( result, exp1left, exp_tail1right), rest671)
end
|  ( 52, ( ( _, ( MlyValue.ntVOID exp_tail1, _, exp_tail1right)) :: (
...
exp1 = exp1 ()
 ...
 in ( LrTable.NT 13, ( result, SEMICOLON1left, exp_tail1right), 
rest671)
end
...
|  ( 55, ( ( _, ( MlyValue.ntVOID param_tail1, _, param_tail1right))
 :: ( _, ( MlyValue.ntVOID exp1, exp1left, _)) :: rest671)) => let
 val  result = MlyValue.ntVOID (fn _ => ( let val  exp1 = exp1 ()
 val  param_tail1 = param_tail1 ()
 in ()
end; ()))
 in ( LrTable.NT 14, ( result, exp1left, param_tail1right), rest671)

end
|  ( 56, ( ( _, ( MlyValue.ntVOID param_tail1, _, param_tail1right))
 ...
 in ( LrTable.NT 15, ( result, COMMA1left, param_tail1right), rest671)
...
|  ( 59, ( ( _, ( MlyValue.ntVOID rec_tail1, _, rec_tail1right)) :: (
 _, ( MlyValue.ntVOID exp1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, 
ID1left, _)) :: rest671)) => let val  result = MlyValue.ntVOID (fn _
 => ( let val  ID1 = ID1 ()
 val  exp1 = exp1 ()
 val  rec_tail1 = rec_tail1 ()
 in ()
end; ()))
 in ( LrTable.NT 16, ( result, ID1left, rec_tail1right), rest671)
end
|  ( 60, ( rest671)) => let val  result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 17, ( result, defaultPos, defaultPos), rest671)
end
|  ( 61, ( ( _, ( MlyValue.ntVOID rec_tail1, _, rec_tail1right)) :: (
...
MlyValue.ntVOID (fn _ => ( let val  ID1 = ID1 ()
 ...
 in ( LrTable.NT 17, ( result, COMMA1left, rec_tail1right), rest671)
