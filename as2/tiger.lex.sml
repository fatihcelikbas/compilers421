...
fun yyAction49 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; curr := STR; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ94(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ33 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ103(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            ...
            if inp = #"\\"
              ...
              then if inp = #"!"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction51(strm, yyNO_MATCH)
                          else yyQ7(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                    else if inp = #" "
              ...
              then if inp = #"_"
                  ...
                  then if inp = #"]"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ10(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp = #"f"
                  then yyQ7(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyAction51(strm, yyNO_MATCH)
            else if inp = #"o"
